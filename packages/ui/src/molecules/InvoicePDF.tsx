  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Contract Details */}
        <Text style={styles.sectionHeader}>Contract Details</Text>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.details}>
          This contract is permanently linked to a smart contract on the{' '}
        ...
        {qrCodeUrl && (
          <View style={styles.qrCodeContainer}>
            <Text style={{ fontSize: 10, marginBottom: 4 }}>
              Scan to view contract & verify on-chain
            </Text>
